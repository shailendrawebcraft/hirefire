    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-12 top-search-holder">
                <!-- ====================== SEARCH AREA ======================== -->
                <div id="search-area" class="search-area mb-3">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-0 animate-dropdown top-cart-row">
                ...
                <div class="dropdown dropdown-cart dropdown-cart-one d-none">
  ...
  <div class="modal fade" id="userFormModal" data-backdrop="static" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route("add.enquiry") }}" method="POST" enctype="multipart/form-data" >
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input name="productid" type="hidden" class="form-control"
                            id="product_id" value="{{$product->id}}" required/>
                        <input name="productname" type="hidden" class="form-control"
                            id="product_name" value="{{$product->product_name}}" required/>
                        <input name="producturl" type="hidden" class="form-control"
                            id="product_url" value="{{Request::url()}}" required/>
                    </div>
                    <div class="form-group">
            ...
            <form action="{{ route("add.enquiry") }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input name="productid" type="hidden" class="form-control"
                            id="product_id" value="{{$pro->id}}" required/>
                        <input name="productname" type="hidden" class="form-control"
                            id="product_name" value="{{$pro->product_name}}" required/>
                        <input name="producturl" type="hidden" class="form-control"
                            id="product_url" value="{{Request::url()}}" required/>
                    </div>
                    <div class="form-group">

...
<div class="body-content outer-top-vs" id="top-banner-and-menu">
    ...
    <div class="container-fluid">
        ...
        <div id="app" class="row no-gutters">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 {{ env('HIDE_SIDEBAR') == 0 ? 'col-xl-12' : 'col-xl-10' }} right-sidebar">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 right-sidebar mt-4 mb-4">
                <div class="row">
                        ...
                        <div class="item">
                            <div class="blog-post">
                                <div class="blog-post-image">
                                    <div class="image">
                                        <a title="Recovery Truck" href="{{ route('recoverytruck') }}">
                                            <img src="http://127.0.0.1:8000/images/blog/1605787994blog_big_03.jpg" alt="http://127.0.0.1:8000/images/blog/1605787994blog_big_03.jpg">
                                        </a>
                                    </div>
                                </div> 
                                <div class="blog-post-info text-center">
                                    <h3 class="name">
                                        <a href="{{ route('recoverytruck') }}">Recovery Truck</a>
                                    </h3> 
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">    
                        <div class="item">
                            <div class="blog-post">
                                <div class="blog-post-image">
                                    <div class="image">
                                        <a title="Unique UI" href="{{ route('mainindex') }}">
                                            <img src="http://127.0.0.1:8000/images/blog/1605787994blog_big_03.jpg" alt="http://127.0.0.1:8000/images/blog/1605787994blog_big_03.jpg">
                                        </a>
                                    </div>
                                </div> 
                                <div class="blog-post-info text-center">
                                    <h3 class="name">
                                        <a href="{{ route('mainindex') }}">Consultancy Services</a>
                                    </h3> 
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">    
                        <div class="item">
                            <div class="blog-post">
                                ...
                                <div class="blog-post-info text-center">
                                    <h3 class="name">
                                        <a href="{{ route('mainindex') }}">Rental Vehicles</a>
                                    </h3> 
                                </div>
                            </div>
                        </div>

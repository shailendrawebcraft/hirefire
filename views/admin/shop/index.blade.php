...
<div class="col-md-6">
  <div class="widgetbar">
        ...
        @endcan
        @can('products.create')
            <a href="{{ route('shop.create') }}" class="float-right btn btn-primary-rgba mr-2">
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{ __('Workshops') }}</h5>
        </div>
        <div class="card-body">
         <!-- main content start -->
    ...
    $(function () {
        ...
        var table = $('#d_products').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'id',
                    name: 'recovery_truck_shop.id'
                },
                {
                    data: 'name',
                    name: 'recovery_truck_shop.name'
                },
                {
                    data: 'location',
                    name: 'recovery_truck_shop.location'
                },
                {
                    data: 'emirates',
                    name: 'recovery_truck_shop.emirates'
                },
                {
                    data: 'shoptypes',
                    name: 'shoptypes',
                ...
                {
                    data: 'timing',
                    name: 'recovery_truck_shop.timing'
                },
                {
                    data: 'closing_days',
                    name: 'recovery_truck_shop.closing_days'
                },
                {
                    data: 'status',
                    name: 'recovery_truck_shop.status'
                },
                {
                    data: 'action',
                    name: 'action',

...
<div class="col-md-6">
    <div class="widgetbar">
        <a href="{{ route('shoptype.index') }}" class="btn btn-primary-rgba"><i
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body ml-2">
                    <!-- main content start -->
                    <form action="{{ route("shoptype.store") }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark">{{ __("Shop Type Name : ") }}<span
                                            class="text-danger">*</span></label>
                                    <input placeholder="{{ __("Shop Type Name") }}" required type="text"

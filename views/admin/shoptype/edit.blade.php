...
@section('title',__('Edit Shop Type :Shop Type | ',['truck' => $truck->name]))
@section('stylesheet')
...
@slot('button')
    <div class="col-md-6">
        <div class="widgetbar">
            <a href="{{ route('shoptype.index') }}" class="btn btn-primary-rgba">
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{__("Edit Shop type")}} {{ $truck->name }}</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="tab-pane fade show active" id="productdetails" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <!-- <div class="row"> -->
                                    <form action="{{ route("shoptype.update",$truck->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="text-dark">{{__("Vehicle Type Name:")}} <span
                                                            class="text-danger">*</span></label>
                                                    <input placeholder="{{ __("Enter vehicle type name") }}" required
                                                        type="text" value="{{ $truck->name }}"
    ...
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <p>Do you really want to delete these shop type? This process cannot be undone.</p>
        </div>

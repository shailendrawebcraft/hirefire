...
<div class="col-md-6">
  ...
  <a href="{{url('admin/slider3')}} " class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i> {{ __("Back") }}</a>
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        ...
        <form action="{{ route('slider3.update',$slider->id) }}" method="POST" enctype="multipart/form-data">
          ...
          @csrf
           ...
           <div class="row">
             ...
             <div class="col-md-5">
               ...
               <img id="slider_preview" class="img-fluid" alt="Responsive image" title="Slider Image Preview" align="center" src="{{ url('images/slider3/'.$slider->image) }}">
...
@section('custom-script')
  ...
  <script src="{{ url('js/slider3.js') }}"></script>

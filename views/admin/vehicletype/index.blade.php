...
<div class="col-md-6">
  <div class="widgetbar">
        ...
        @endcan
        @can('products.create')
            <a href="{{ route('vehicletype.create') }}" class="float-right btn btn-primary-rgba mr-2">
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{ __('Vehicle Types') }}</h5>
        </div>
        <div class="card-body">
         <!-- main content start -->
    ...
    $(function () {
        ...
        var table = $('#d_products').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'id',
                    name: 'recovery_truck_vehicle_types.id'
                },
                {
                    data: 'name',
                ...
                {
                    data: 'status',
                    name: 'recovery_truck_vehicle_types.status'
                },
                {
                    data: 'action',
                    name: 'action',

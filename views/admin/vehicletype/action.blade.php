<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
        ...
        <a class="dropdown-item" href="{{route('vehicletype.edit',$row->id)}}"><i class="feather icon-edit mr-2"></i>{{ __("Edit") }}</a>
        @endcan
  ...
  <div class="modal-dialog modal-sm">
      <div class="modal-content">
          ...
          <div class="modal-footer">
              <form method="post" action="{{route('vehicletype.destroy',$row->id)}}" class="pull-right">
              {{csrf_field()}}
              {{method_field("DELETE")}}

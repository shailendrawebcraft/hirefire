...
<div class="col-md-6">
    <div class="widgetbar">
        <a href="{{ route('vehicletype.index') }}" class="btn btn-primary-rgba"><i
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{ __('Create New Vehicle Type') }}</h5>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input placeholder="{{ __("Vehicle Type Name") }}" required type="text"
                                        value="{{ old('vehicle_number') }}" class="form-control" name="name">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <small class="text-muted"><i class="fa fa-question-circle"></i> {{ __("Toggle the vehicle type status") }}</b></small>
                                </div>
                            </div>
                        </div>
                </div>

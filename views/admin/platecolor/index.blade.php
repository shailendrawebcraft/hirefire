...
@section('title',__('Manage Recovery Truck | '))
@section('body')
@component('admin.component.breadcumb',['thirdactive' => 'active'])
@slot('heading')
{{ __('Manage Recovery Truck') }}
@endslot
@slot('menu2')
{{ __("Plate Color") }}
@endslot
...
<div class="col-md-6">
  <div class="widgetbar">
        ...
        @endcan
        @can('products.create')
            <a href="{{ route('platecolor.create') }}" class="float-right btn btn-primary-rgba mr-2">
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{ __('Plate Color') }}</h5>
        </div>
        <div class="card-body">
         <!-- main content start -->
...
<script>
    $(function () {
        ...
        var table = $('#d_products').DataTable({
            ...
            serverSide: true,
            stateSave: true,
            ajax: '{{ route("platecolor.index") }}',
            language: {
                searchPlaceholder: "Search Plate Color or Code..."
            },
            columns: [
                {
                    data: 'DT_RowIndex',
                ...
                {
                    data: 'id',
                    name: 'plate_color_registrations.id'
                },
                {
                    data: 'plate_code',
                    name: 'plate_color_registrations.plate_code'
                },
                {
                    data: 'location',
                ...
                {
                    data: 'vehicle_type',
                    name: 'recovery_truck_vehicle_types.name'
                },
                {
                    data: 'status',
                    name: 'plate_color_registrations.status'
                },
                {
                    data: 'action',
                    name: 'action',

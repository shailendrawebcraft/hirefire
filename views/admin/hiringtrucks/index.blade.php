...
<div class="col-md-6">
  <div class="widgetbar">
        ...
        @endcan
        @can('products.create')
            <a href="{{ route('hiring-trucks.create') }}" class="float-right btn btn-primary-rgba mr-2">
...
<script>
    $(function () {
        ...
        var table = $('#d_products').DataTable({
            ...
            serverSide: true,
            stateSave: true,
            ajax: '{{ route("hiring-trucks.index") }}',
            language: {
            ...
            columns: [
                ...
                {
                    data: 'id',
                    name: 'hiring_trucks.id'
                },
                {
                    data: 'vehicle_number',
                    name: 'hiring_trucks.vehicle_number'
                },
                {
                    data: 'driver_name',
                    name: 'hiring_trucks.driver_name'
                },
                {
                    data: 'mobile_number',
                    name: 'hiring_trucks.mobile_number'
                },
                {
                    data: 'status',
                    name: 'hiring_trucks.status'
                },
                {
                    data: 'action',
                    name: 'action',

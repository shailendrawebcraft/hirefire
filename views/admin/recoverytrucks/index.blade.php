...
@section('title',__('Recovery Trucks | '))
@section('body')
      ...
      <div class="card m-b-30">
        ...
        <table id="d_products" class="w-100 table table-bordered table-hover">
            <thead>
                ...
                <!-- <th>{{ __("ID") }}</th> -->
                <th>{{ __('Code') }}</th>
                <th>{{ __('Truck Plate Code/Color/Plate No.') }}</th>
                <th>{{ __('Status') }}</th>
                <th>{{ __('Action') }}</th>
            </thead>
        </table>                
...
<script>
    $(function () {
        ...
        var table = $('#d_products').DataTable({
            ...
            serverSide: true,
            stateSave: true,
            ajax: '{{ route("recoverytruck.index") }}',
            language: {
            ...
            columns: [
                ...
                {
                    data: 'code',
                    name: 'recovery_trucks.code'
                },
                {
                    data: 'vehicle_number',
                    name: 'recovery_trucks.vehicle_number'
                },
                {
                    data: 'status',
                    name: 'recovery_trucks.status'
                },
                {
                    data: 'action',
                    name: 'action',

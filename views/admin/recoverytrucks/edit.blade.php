...
@slot('button')
    <div class="col-md-6">
        <div class="widgetbar">
            <a href="{{ route('recoverytruck.index') }}" class="btn btn-primary-rgba">
                        ...
                        <div class="tab-pane fade show active" id="productdetails" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <!-- <div class="row"> -->
                                    <form action="{{ route("recoverytruck.update",$truck->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="{{ __("Code") }}" type="text" value="{{ $truck->code }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input placeholder="{{ __("Enter Truck Plate Code/Color/Plate No.") }}" required

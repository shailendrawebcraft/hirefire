                             ...
                             <a href="javascript:void(0)" id="notification-open" class="infobar-icon">
                                 ...
                                 <span class="live-icon">
                                     ...
                                     <span id="countNoti" class="label label-warning">
                                         ...
                                         {{ auth()->user()->unreadnotifications()->whereIn('n_type', ['order_v','booking'])->count() }}
 ...
 <div id="notification-sidebar" class="infobar-settings-sidebar">
     <div class="infobar-settings-sidebar-head d-flex w-100 justify-content-between">
         <h4>@if(auth()->user()->unreadnotifications->whereIn('n_type', ['order_v','booking'])->count())
             {{__("You have")}} {{ auth()->user()->unreadnotifications->whereIn('n_type', ['order_v','booking'])->count() }} {{__("New Orders")}} {{__("Notification!")}}
     ...
     <div class="infobar-settings-sidebar-body">
         @if(auth()->user()->unreadnotifications->whereIn('n_type', ['order_v','booking'])->count())
         ...
         <div class="p-3" style="maxheight: 500px;overflow: auto">
             ...
             @foreach(auth()->user()->unreadNotifications->whereIn('n_type', ['order_v','booking']) as $notification)

...
<div class="col-md-6">
  <div class="widgetbar">
        ...
        @endcan
        @can('products.create')
            <a href="{{ route('driver.create') }}" class="float-right btn btn-primary-rgba mr-2">
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{ __('Drivers') }}</h5>
        </div>
        <div class="card-body">
         <!-- main content start -->
    ...
    $(function () {
        ...
        var table = $('#d_products').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'code',
                    name: 'recovery_truck_drivers.code'
                },
                {
                    data: 'driver_name',
                    name: 'recovery_truck_drivers.driver_name'
                },
                {
                    data: 'mobile_number',
                    name: 'recovery_truck_drivers.mobile_number'
                },
                {
                    data: 'status',
                    name: 'recovery_truck_drivers.status'
                },
                {
                    data: 'action',
                    name: 'action',

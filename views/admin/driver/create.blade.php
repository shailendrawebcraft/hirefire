...
<div class="col-md-6">
    <div class="widgetbar">
        <a href="{{ route('driver.index') }}" class="btn btn-primary-rgba"><i
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{ __('Create New Driver') }}</h5>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input placeholder="{{ __("Enter Code") }}" type="text"
                                        value="{{ old('code') }}" class="form-control" name="code">
                                </div>
                            </div>

...
@section('title',__('Edit Driver :truck | ',['truck' => $truck->vehicle_number]))
@section('stylesheet')
...
@slot('button')
    <div class="col-md-6">
        <div class="widgetbar">
            <a href="{{ route('driver.index') }}" class="btn btn-primary-rgba">
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{__("Edit Driver")}} {{ $truck->driver_name }}</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="tab-pane fade show active" id="productdetails" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <!-- <div class="row"> -->
                                    <form action="{{ route("driver.update",$truck->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="text-dark">{{__("Code:")}} </label>
                                                    <input placeholder="{{ __("Enter code") }}"
                                                        type="text" value="{{ $truck->code }}"
    ...
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <p>Do you really want to delete these driver? This process cannot be undone.</p>
        </div>

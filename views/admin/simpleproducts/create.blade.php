                ...
                <div class="card-body ml-2">
                    ...
                    <form action="{{ route("simple-products.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="text-dark">{{ __("Hire :") }}</label>
                                    <br>
                                    <label class="switch">
                                        <input type="checkbox" name="hire"
                                            {{ old('hire') == '1' ? "checked" : "" }}>
                                        <span class="knob"></span>
                                    </label>
                                    <br>
                                    <small class="text-muted"><i class="fa fa-question-circle"></i> {{ __("Toggle to allow Hire on product.") }}</b></small>
                                </div>
                            </div>

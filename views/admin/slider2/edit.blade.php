  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        ...
        <form action="{{ route('slider2.update',$slider->id) }}" method="POST" enctype="multipart/form-data">
          ...
          @csrf
           ...
           <div class="row">
             ...
             <div class="col-md-5">
               ...
               <img id="slider_preview" class="img-fluid" alt="Responsive image" title="Slider Image Preview" align="center" src="{{ url('images/slider2/'.$slider->image) }}">
...
@section('custom-script')
  ...
  <script src="{{ url('js/slider2.js') }}"></script>
